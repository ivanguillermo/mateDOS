const WEB_APP_URL = "https://script.google.com/macros/s/AKfycbzajpb5gR4cZdnyfyCWz5DdaFu46bVIq1002xPK82iarr3GYA8c_Zo04NEEV163EJfprA/exec";
...
const siteContent = {
    fundamentacion: {
        ...
        html: `
            <p class="mb-4 text-slate-600">El curso de <strong>Matemática II</strong> (Código: 175-176-177) forma parte del ciclo de Estudios Generales de la Universidad Nacional Abierta (UNA). Es un curso básico y obligatorio orientando sus estrategias hacia la resolución de ejercicios y problemas para promover la integración entre la teoría y la práctica.</p>
